  ...
  <main class="page-about mt-0">
    ...
    <section class="about container">
      ...
      <p class="text-md mb-24">
        我叫魏依嫻，是一個擁有基礎前端技能並持續學習的 UI/UX 設計師，設計的產品包含 B2C 電商、B2B
        SasS 產品、形象官網等。工作時總是在功能與美學、通用性與工程實作中找尋最佳平衡。
        <br>
        在規劃 UX 的任何一步心中都需要有一個合理的解答，因為問題的解法很多也沒有一定正確的，所以你需要更清楚自己的解法。
      </p>
      ...
      <div class="row mb-48">
        ...
        <div class="col-xl-2 col-md-3 col-4 text-align-center">
          <img
            ...
            alt="..."
          />
          <p class="text-sm-bold text-align-center">JavaScript ( 學習中 )</p>
        </div>
        <div class="col-xl-2 col-md-3 col-4 text-align-center">
          <img
        ...
        <div class="col-xl-2 col-md-3 col-4 text-align-center">
          <img
            ...
            alt="..."
          />
          <p class="text-sm-bold text-align-center">Premiere</p>
        </div>
      </div>
    </section>
        ...
        <div class="connection-area">
          ...
          <div class="row connect-way">
            ...
            <div class="linkedin mb-8 col-sm-6 content-pl-48">
              ...
              <a
                href="https://www.linkedin.com/in/edna-wei-90292b97/"
                target="_blank"
                >LinkedIn Profile</a
              >
            </div>
